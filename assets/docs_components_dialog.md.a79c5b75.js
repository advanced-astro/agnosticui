import{_ as m,a as q,b as v,c as b}from"./Angular-icon.63775078.js";import"./common.min.821ee339.js";import"./index.56618267.js";import{_ as y,h,D as f,I as w,r as c,o as i,c as k,e as s,w as p,a as n,b as a,d as r}from"./app.e1c289e3.js";const x={name:"DialogExamples",components:{Button:h,Dialog:f,Input:w},setup(){let t=null;return{openDialog:()=>{t&&t.show()},assignDialogRef:o=>{t=o}}}},_=n("h3",null,"Dialog",-1),B=n("p",{class:"mbe24"},[a(" The following button opens the dialog because we've obtained a dialog "),n("code",null,"instance"),a(" handle via the "),n("code",null,'@instance="assignDialogRef"'),a(" event hook. This is Vue syntax but the other framework implementations emit the "),n("code",null,"instance"),a(" event similarly: ")],-1),D=a(" Open dialog via dialogRef "),I=n("p",{class:"mbs24 mbe16"},[a(" The following also opens because a11y-dialog will bind to element with "),n("code",null,"data-a11y-dialog-show"),a(" attribute: ")],-1),A=n("button",null,null,-1),R=a(" Open the dialog via data attribute "),T=a(" My Dialog "),C=n("p",{class:"mbs16 mbe16"}," Fill in the form below to receive our newsletter! ",-1),S={class:"dialog-form-demo"},U=n("div",{class:"mbe16"},null,-1),N=a(" Sign Up ");function E(t,l,u,o,O,P){const e=c("Button"),g=c("Input"),d=c("Dialog");return i(),k("section",null,[_,B,s(e,{mode:"primary","is-bordered":!0,"is-block":!0,"is-rounded":!0,type:"button",onClick:o.openDialog},{default:p(()=>[D]),_:1},8,["onClick"]),I,A,s(e,{type:"button","data-a11y-dialog-show":"a11y-dialog",mode:"primary","is-bordered":!0,"is-block":!0,"is-rounded":!0},{default:p(()=>[R]),_:1}),s(d,{id:"a11y-dialog","dialog-root":"body","is-animation-fade-in":!0,"is-animation-slide-up":!0,role:"dialog","class-names":{title:"h4 mbe18 flex justify-center"},onInstance:o.assignDialogRef},{title:p(()=>[T]),default:p(()=>[C,n("form",S,[s(g,{"is-rounded":!0,label:"Email (required)",type:"email",name:"EMAIL",id:"email",placeholder:"email@example.com",required:""}),U,s(e,{type:"submit",mode:"primary","is-rounded":!0,"is-block":!0},{default:p(()=>[N]),_:1})])]),_:1},8,["onInstance"])])}var M=y(x,[["render",E]]);const V=r('<h1 id="dialog" tabindex="-1">Dialog <a class="header-anchor" href="#dialog" aria-hidden="true">#</a></h1><p>AgnosticUI&#39;s <a href="https://www.w3.org/TR/wai-aria-practices/#dialog_modal" target="_blank" rel="noopener noreferrer">Dialog</a> component wraps Kitty Giraudel&#39;s <a href="https://github.com/KittyGiraudel/a11y-dialog" target="_blank" rel="noopener noreferrer">a11y-dialog</a> \u2014 an accessible and inclusive dialog component that has been battle tested over several versions to date.</p><div class="mbs24"></div><h2 id="examples" tabindex="-1">Examples <a class="header-anchor" href="#examples" aria-hidden="true">#</a></h2><div class="mbe24"></div>',5),j=r('<div class="mbe32"></div><h2 id="usage" tabindex="-1">Usage <a class="header-anchor" href="#usage" aria-hidden="true">#</a></h2><p>Note that by default <code>Dialog</code> will use <code>role=&quot;dialog&quot;</code> and behave like a <em>dialog</em>. This means that in addition to the open/close trigger button dismissing the dialog, you can also click <code>ESC</code> or click outside the dialog e.g. on the overlay and the dialog will be dismissed.</p><div class="mbe24"></div><p>If you&#39;d like a <span class="quoted">sticky dialog</span> that only closes by toggling the trigger button and/or a close button you&#39;ve setup, you can pass <code>role=&quot;alertdialog&quot;</code> and <code>ESC</code> or click outside the dialog will NOT dismiss the dialog. Read more about this on <a href="https://a11y-dialog.netlify.app/advanced/alert-dialog" target="_blank" rel="noopener noreferrer">a11y-dialog&#39;s alertdialog docs page</a>.</p><div class="flex"><h3 id="react" tabindex="-1"><img src="'+m+`" alt="react logo">React </h3></div><details class="disclose disclose-bordered"><summary class="disclose-title">View source</summary><div class="language-jsx"><pre><code><span class="token keyword">import</span> <span class="token punctuation">{</span> useRef <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;react&#39;</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">const</span> <span class="token function-variable function">YourComponent</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div></details><p>React: <a href="https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-react/src/Dialog.tsx" target="_blank" rel="noopener noreferrer">component source</a></p><div class="mbe32"></div><div class="flex"><h3 id="vue-3" tabindex="-1"><img src="`+q+`" alt="Vue 3 logo">Vue 3 </h3></div><details class="disclose disclose-bordered"><summary class="disclose-title">View source</summary><div class="language-vue"><pre><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>section</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
</code></pre></div></details><p>Vue 3: <a href="https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-vue/src/components/Dialog.vue" target="_blank" rel="noopener noreferrer">component source</a>, <a href="https://github.com/AgnosticUI/agnosticui/blob/master/agnostic-vue/examples/src/App.vue#L225" target="_blank" rel="noopener noreferrer">examples</a></p><div class="mbe24"></div><div class="flex"><h3 id="svelte" tabindex="-1"><img src="`+v+`" alt="Svelte logo">Svelte </h3></div><div class="mbe32"></div><details class="disclose disclose-bordered"><summary class="disclose-title">View source</summary><p><strong>Please consider Svelte Dialog experimental and not yet ready for production until we can add <a href="https://github.com/AgnosticUI/svelte-a11y-dialog/issues/1" target="_blank" rel="noopener noreferrer">missing tests</a></strong> \u2014 tl;dr is we&#39;d like to write tests utilizing Cypress&#39;s component testing framework but we need to await an upcoming Vite + Cypress plugins to do so.</p><p>In your main <code>app.html</code>, add a container where your dialog will be rendered into \u2014 <code>dialog-root</code> in this example:</p><div class="language-html"><pre><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">&gt;</span></span>
...
</code></pre></div><p>See <a href="https://github.com/AgnosticUI/agnosticui/blob/master/CONTRIBUTING.md#usage" target="_blank" rel="noopener noreferrer">Running Storybook</a>.</p>`,27),K='{"title":"Dialog","description":"","frontmatter":{},"headers":[{"level":2,"title":"Examples","slug":"examples"},{"level":2,"title":"Usage","slug":"usage"},{"level":2,"title":"Storybook","slug":"storybook"}],"relativePath":"docs/components/dialog.md","lastUpdated":1648905211512}',L={},z=Object.assign(L,{setup(t){return(l,u)=>(i(),k("div",null,[V,s(M),j]))}});export{K as __pageData,z as default};
