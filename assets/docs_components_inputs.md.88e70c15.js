...
</code></pre></div><p>See <a href="https://github.com/AgnosticUI/agnosticui/blob/master/CONTRIBUTING.md#running-monorepo" target="_blank" rel="noopener noreferrer">Running monorepo</a>.</p>`,19),Z='{"title":"Input","description":"","frontmatter":{},"headers":[{"level":2,"title":"Examples","slug":"examples"},{"level":2,"title":"Usage","slug":"usage"},{"level":2,"title":"Storybook","slug":"storybook"}],"relativePath":"docs/components/inputs.md","lastUpdated":1648608419381}',F={},nn=Object.assign(F,{setup(k){return(i,r)=>(u(),l("div",null,[P,n($),H,n(h(b),{type:"warning"},{default:t(()=>[Y]),_:1}),W]))}});export{Z as __pageData,nn as default};
