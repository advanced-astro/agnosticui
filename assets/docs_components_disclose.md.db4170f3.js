...
</code></pre></div></details><p>See <a href="https://github.com/AgnosticUI/agnosticui/blob/master/CONTRIBUTING.md#usage" target="_blank" rel="noopener noreferrer">Running Storybook</a>.</p>`,23),Y='{"title":"Disclose","description":"","frontmatter":{},"headers":[{"level":2,"title":"Examples","slug":"examples"},{"level":2,"title":"Usage","slug":"usage"},{"level":2,"title":"Storybook","slug":"storybook"}],"relativePath":"docs/components/disclose.md"}',F={},L=Object.assign(F,{name:"disclose",setup(c){return(i,r)=>(o(),p("div",null,[I,n(C),B]))}});export{Y as __pageData,L as default};
